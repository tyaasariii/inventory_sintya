...
--
-- Host: localhost:3306
-- Generation Time: Feb 20, 2025 at 04:18 AM
...
--
-- Database: `db_inventory_sintya_xi4`
--
...
(1, 'mie instan', 111, 3000, 30),
(2, 'teh pucuk', 222, 4000, 45),
(3, 'susu', 333, 7000, 50);
...
CREATE TABLE `jenis` (
  ...
  `nama_jenis` varchar(60) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
