...
<div class="container">
  ...
  <div class="mb-3">
    ...
    <input type="email" class="form-control" name="id_jenis" id="exampleInputEmail1" aria-describedby="emailHelp">
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Nama Jenis</label>
    <input type="password" class="form-control" name="nama_jenis" id="exampleInputPassword1">
  </div>
